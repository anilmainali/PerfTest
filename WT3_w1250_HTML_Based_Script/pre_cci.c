# 1 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c"
...
# 1 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
# 2 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
# 3 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
# 4 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
Action()
{
	...
	lr_end_transaction("WT3_T03_URL_Landing",2);
	...
	web_submit_data("login.pl_5", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=userSession", "Value=116412.464074524fQiHQzzpVcAiDDDDDfQcHpHQzHcf", "ENDITEM", 
	...
	lr_end_transaction("WT3_T08_SignIn",2);
	...
	lr_end_transaction("WT3_T21_Travel_Home",2);
	...
	lr_end_transaction("WT3_T22_Travel_Search_Flight",2);
	...
	lr_end_transaction("WT3_T23_Travel_Flight_Lookup",2);
	...
	lr_end_transaction("WT3_T24_Find_Flight",2);
	...
	lr_end_transaction("WT3_T25_Travel_Payment_Details",2);
	...
	lr_end_transaction("WT3_T33Travel_Check_Itinerary",2);
	...
	lr_end_transaction("WT3_T09_SignOut",2);

	return 0;
}
# 5 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
Rec_WT3()
{
	...
	lr_end_transaction("WT3_T04_SignUp_Error",2);
	...
	lr_end_transaction("WT3_T05_SignUp",2);
	...
	lr_end_transaction("WT3_T07_SignIn_Error",2);
...
# 6 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
# 7 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
...
# 8 "c:\\lr\\scripts\\wt3_w1250_html_based_script\\\\combined_WT3_w1250_HTML_Based_Script.c" 2
